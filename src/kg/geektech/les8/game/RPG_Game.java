...
public class RPG_Game {
    ...
    static TrickyBastar trickyBastar;
    public static void start() {
        ...
        Thor thor = new Thor(270, 12);
        Tank tank = new Tank(400,8);
        trickyBastar = new  TrickyBastar(255,20);
        Haker haker = new Haker(240,10);


        Hero[] heroes = {warrior, doc, magic, berserk, assistant,thor, tank, trickyBastar, haker};
    ...
    private static void heroesApplySuperPower(Boss boss, Hero[] heroes) {
        ...
        for (int i = 0; i < heroes.length; i++) {
            if (heroes[i].getHealth() > 0 && boss.getHealth() > 0 && trickyBastar.isDead() || !trickyBastar.isDead()) {
